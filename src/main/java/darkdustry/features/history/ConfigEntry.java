...
public class ConfigEntry implements HistoryEntry {
    ...
    public String getMessage(Player player) {
        ...
        return switch (config) {
            case UnlockableContent content -> Bundle.format("history.config", player, info.lastName, block.emoji(), content.emoji(), Bundle.formatRelative(player, timestamp));
            ...
            case UnitCommand command -> Bundle.format("history.config.command", player, info.lastName, block.emoji(), command.getEmoji(), Bundle.formatRelative(player, timestamp));
