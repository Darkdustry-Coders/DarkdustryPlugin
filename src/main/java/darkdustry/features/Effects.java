...
public class Effects {
    ...
    public static void load() {
        ...
        pack6 = new FxPack(p -> on(Fx.teleportActivate, p), p -> on(Fx.teleport, p), p -> on(Fx.smeltsmoke, p, 0f, Color.scarlet));
        pack7 = new FxPack(p -> on(Fx.teleportActivate, p), p -> on(Fx.teleport, p), p -> on(Fx.smeltsmoke, p, 0f, Color.#8d56b1));
