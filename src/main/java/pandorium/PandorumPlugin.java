...
import pandorium.database.ArrowSubscriber;
import pandorium.entry.ConfigEntry;
import pandorium.entry.HistoryEntry;
import pandorium.events.*;
import pandorium.models.PlayerInfo;
import pandorium.struct.CacheSeq;
import pandorium.struct.Tuple2;
import pandorium.vote.*;
...
public final class PandorumPlugin extends Plugin{
    ...
    public void init() {
        ...
        Events.on(PlayerUnbanEvent.class, pandorium.events.PlayerUnbanEvent::call);
        Events.on(PlayerBanEvent.class, pandorium.events.PlayerBanEvent::call);
        Events.on(ServerLoadEvent.class, pandorium.events.ServerLoadEvent::call);
        Events.on(WorldLoadEvent.class, pandorium.events.WorldLoadEvent::call);
        Events.on(BlockBuildEndEvent.class, pandorium.events.BlockBuildEndEvent::call);
        Events.on(ConfigEvent.class, pandorium.events.ConfigEvent::call);
        Events.on(TapEvent.class, pandorium.events.TapEvent::call);
        Events.on(DepositEvent.class, pandorium.events.DepositEvent::call);
        Events.on(BuildSelectEvent.class, pandorium.events.BuildSelectEvent::call);
        Events.on(PlayerJoin.class, PlayerJoinEvent::call);
        Events.on(PlayerLeave.class, PlayerLeaveEvent::call);
        Events.on(GameOverEvent.class, pandorium.events.GameOverEvent::call);
